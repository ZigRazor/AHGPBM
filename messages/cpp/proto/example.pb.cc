...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fexample_2eproto = {
  false, false, 107, descriptor_table_protodef_proto_2fexample_2eproto, "proto/example.proto", 
  &descriptor_table_proto_2fexample_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_proto_2fexample_2eproto::offsets,
  file_level_metadata_proto_2fexample_2eproto, file_level_enum_descriptors_proto_2fexample_2eproto, file_level_service_descriptors_proto_2fexample_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_proto_2fexample_2eproto_getter() {
  return &descriptor_table_proto_2fexample_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_proto_2fexample_2eproto(&descriptor_table_proto_2fexample_2eproto);
...
::PROTOBUF_NAMESPACE_ID::Metadata SearchRequest::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_proto_2fexample_2eproto_getter, &descriptor_table_proto_2fexample_2eproto_once,
      file_level_metadata_proto_2fexample_2eproto[0]);
}
